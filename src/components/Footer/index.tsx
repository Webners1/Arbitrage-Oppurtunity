        ...
        <div className="grid grid-cols-2 gap-10 pt-8 border-t md:grid-cols-3 lg:grid-cols-6 xs:px-6 border-dark-900">
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-start gap-2">
              <div className="">
                <Image src="https://i.ibb.co/q08Rs7h/favicon.png" alt="Arbitrage Opprtunity logo" width="308px" height="208px" />
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://instagram.com/arbitrage_opportunity_?igshid=Y2IzZGU1MTFhOQ==" target="_blank" rel="noreferrer">
                <InstagramIcon width={16} className="text-low-emphesis" />
              </a>
              <a href="https://t.me/arbitrageopportunityofficial" target="_blank" rel="noreferrer">
